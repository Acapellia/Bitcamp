...
namespace ScreenTransferProgram
{
    class ScreenCapture
    {
        ...
        private void init()
        {
            ...
            //cameraInit(mScreenWidth, mScreenHeight);
        }

        public void cameraInit(int cameraNum)
        {
            capture = new VideoCapture(cameraNum);
            frame = new Mat();
            capture.Set(VideoCaptureProperties.FrameWidth, mScreenWidth);
            capture.Set(VideoCaptureProperties.FrameHeight, mScreenHeight);
        }
