...
void main()
{
	...
	*/
	...
	pair<string, int> monthDays[] = {
		make_pair("JAN",31), make_pair("FEB",28), make_pair("MAR",31), make_pair("AFR",30), make_pair("MAY",31),
		make_pair("JUN",30), make_pair("JUL",31), make_pair("AUG",31), make_pair("SEP",30), make_pair("OCT",31),
