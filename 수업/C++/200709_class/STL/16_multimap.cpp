...
void main()
{
	...
	pair<int, string> yearMovie[] = {
		...
		make_pair(2003, "올드보이"), make_pair(1994,"라이온킹"), make_pair(1999,"매트릭스"),
		make_pair(1994, "포레스트 검프"), make_pair(2018, "어벤져스 엔드게임")
	};
	...
	while (true) {
		...
		if (result.first == result.second)
			...
			for (yearMovieIt it = result.first; it != result.second; it++) {
				cout << (*it).second << endl;
			}
		}
	}	
